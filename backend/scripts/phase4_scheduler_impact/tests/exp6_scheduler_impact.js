...
const schedulerConflict = new Rate('scheduler_conflict_rate');  // NEW: Scheduler 충돌 감지
...
export function setup() {
    console.log('🚀 Experiment 6: Scheduler Impact Test Starting...');
    console.log(`📊 Backend: ${BASE_URL}`);
    console.log(`👥 Users: ${tokens.length}`);
    console.log(`⏱️  Duration: 8 minutes`);
    console.log(`📈 Load: 0 → 500 → 0 VUsers (Phase 3와 동일)`);
    console.log(`⏰ Scheduler: 30초마다 Portfolio 가격 업데이트 (12번 실행 예상)`);
...
export function teardown() {
    console.log('');
    console.log('✅ Experiment 6 Baseline Test Completed!');
